export const agreement_conditions_data = [
  {
    id: 1,
    title: "§ 1",
    title2: "Definicje",
    description: `„Formularz rejestracyjny” – formularz wypełniany przez Użytkownika niezalogowanego, służący do założenia Konta.
        ...
        „Usługodawca” – Migrostore Sp. z o. o. z siedzibą we Wroclawiu, al. Aleksandra Ostrowskiego 13, 53-238, wpisana do rejestru przedsiębiorców prowadzonego przez Sąd Rejonowy we Wroclaw, VI Wydział Gospodarczy Krajowego Rejestru Sądowego pod nr KRS 0000966678, posiadająca numer identyfikacji podatkowej NIP 8943184905.
  ...
  },
  {
    id: 2,
    title: "§ 2",
    title2: "Postanowienia ogólne",
    description: `Niniejszy Regulamin określa:
    ...
    Usługodawca udostępnia nieodpłatnie w Serwisach Użytkownikowi i Użytkownikowi niezalogowanemu Regulamin przed zawarciem umowy o świadczenie Usług. 
    
    Użytkownik i Użytkownik niezalogowany nie są związani tymi postanowieniami Regulaminu, które nie zostały udostępnione w sposób opisany powyżej.
  ...
  },
  {
    id: 3,
    title: "§ 3",
    title2: "Zawarcie umowy",
    description: `Umowa o świadczenie Usług zostaje zawarta z Użytkownikiem niezalogowanym z chwilą skorzystania przez niego z dowolnych Usług oferowanych w ramach Serwisów, które nie wymagają założenia Konta.
    ...
    Po otrzymaniu prawidłowo wypełnionego Formularza rejestracyjnego lub dokonanym Uwierzytelnieniu, Usługodawca tworzy Konto o nazwie odpowiadającej podanemu przez Użytkownika numerze telefonu. Na wskazany przez Użytkownika nr telefonu wysyłany jest kod aktywacyjny w celu potwierdzenia założenia Konta. 
    Użytkownik ma 60 sekund od momentu otrzymania sms’a aktywacyjnego na dokonanie potwierdzenia założenia Konta. Potwierdzenie założenia Konta zapewnia Użytkownikowi dostęp do Konta i możliwość korzystania z Usług, które wymagają założenia Konta. Jeżeli w terminie 60 sekund od momentu otrzymania sms’a aktywacyjnego Użytkownik nie dokona potwierdzenia założenia Konta, nie będzie miał do niego dostępu i nie będzie mógł korzystać z Usług, które wymagają założenia Konta;
    
    Użytkownik uzyskuje dostęp do utworzonego Konta za pomocą swojego loginu (nr telefonu).
    
    Nr telefonu jest powiązany z Kontem, stanowi konieczną formę identyfikacji Użytkownika aplikacji mobilnej wobec Usługodawcy i będzie wykorzystywany do wszelkiej korespondencji pomiędzy Usługodawcą i
    ...
    Umowa o świadczenie Usług zostaje rozwiązana z Użytkownikiem z chwilą usunięcia Konta z aplikacji mobilnej.
    `,
  },
  {
    id: 4,
    title: "§ 4",
    title2: "Warunki świadczenia usług przez usługodawcę",
    description: `Wymagania techniczne niezbędne do współpracy z systemem teleinformatycznym, którym posługuje się Użytkownik lub Użytkownik niezalogowany i Usługodawca są następujące:
  ...
  },
  {
    id: 5,
    title: "§ 5",
    title2: "Prawa i obowiązki uśługodawcy",
    description: `Usługodawca zobowiązuje się do stałego i nieprzerwanego świadczenia Usług.
    ...
    Usługodawca nie ponosi odpowiedzialności za treści i informacje które Użytkownik i Użytkownik niezalogowany przekazuje do podmiotów zewnętrznych współpracujących z Serwisem.
    `,
  },
  {
    id: 6,
    title: "§ 6",
    title2: "Prawa i obowiązki uźytkownika",
    description: `Użytkownik ma możliwość zarządzania Usługami za pośrednictwem Konta, w tym Ustawień (Prywatność) i zmiany podanych przez siebie danych w dowolnym momencie.
    ...
    Użytkownik oraz Użytkownik niezalogowany korzystając z Usług zobowiązani są do:
  ...
  },
  {
    ...
    Usługodawca nie ponosi wobec Użytkownika lub Użytkownika niezalogowanego naruszającego Regulamin odpowiedzialności za jakiekolwiek szkody powstałe na skutek zaprzestania świadczenia im Usług, w tym na skutek usunięcia Konta.
    ...
    treści udostępniane przez Użytkownika i Użytkownika niezalogowanego który korzysta z Usług innych Serwisów udostępnionych i współpracujących z Usługodawcą a umieszczonych w Serwisie (Landing Page).
  ...
  },
  {
    id: 8,
    title: "§ 8",
    title2: "Ochrona danych osobowych",
    description: `Każdy Użytkownik oraz Użytkownik niezalogowany ma prawo do ochrony jego prywatności przez Usługodawcę.
  ...
  },
  {
    id: 9,
    title: "§ 9",
    title2: "Postępowanie reclamacyjne",
    description: `Użytkownik i Użytkownik niezalogowany mają prawo składać reklamacje w sprawach dotyczących realizacji Usług.
    ...
    na adres Usługodawcy: Migrostore Sp. z o. o., al. Aleksandra Ostrowskiego 13, 53-238 Kętrzyn;
    
    na adres poczty elektronicznej: d.rabota@migrostore.pl.
  ...
  },
  {
    id: 10,
    title: "§ 10",
    title2: "Kontakt z uśługodawcą",
    description: `Użytkownik oraz Użytkownik niezalogowany mogą kontaktować się z Usługodawcą we wszelkich sprawach związanych z korzystaniem z Serwisów: pisemnie na adres Usługodawcy: Migrostore Sp. z o. o., al. Aleksandra Ostrowskiego 13, 53-238 Wroclaw, mailowo na adres: d.rabota@migrostore.pl lub telefonicznie pod numerem telefonu: tel. 791 490 146 w dni robocze od Poniedziałku do piątku w godzinach: 9:00 -16:00.
  ...
  },
  {
    id: 11,
    title: "§ 11",
    title2: "Rozwiązanie umowy lub odstąpienie od umowy",
    description: `Umowa o świadczenie Usług może być rozwiązana przez którąkolwiek ze stron.
  ...
  },
  {
    id: 12,
    title: "§ 12",
    title2: "Postaniwienia końcowe",
    description: `Regulamin obowiązuje bezterminowo. Usługodawca może w każdym czasie z ważnych przyczyn, w tym wskazanych w zakresie odpowiedzialności podmiotu, zakończyć świadczenie Usług (w tym usługi Konta) za pośrednictwem Serwisu, przesyłając o tym informację za pośrednictwem poczty elektronicznej lub sms.
    ...
    Usługi dostępne dla Użytkowników: Konto migrostore.pl
    ...
    Usługi dostępne dla Użytkowników: Aplikacja mobilna „migrostore.pl”
    
    Aplikacja mobilna Usługodawcy umożliwiająca Użytkownikowi lub Użytkownikowi niezalogowanemu korzystanie za pomocą wybranych funkcjonalności aplikacji i jej usług mobilnych z wybranych funkcjonalności Konta i Usług. Dodatkowo aplikacja mobilna umożliwia przy wybranych usługach przeniesienie na strony podmiotów zewnętrznych w celu korzystania z innych usług.
